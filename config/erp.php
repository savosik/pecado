...
return [
    ...
    */
    ...
    |
    | Аффилированные юрлица: расчёты с ними не клиентская дебиторка, и в отчётах
    | отдела продаж им делать нечего. В 1С такой контрагент может выглядеть
    | внешним — там он отсекается по типу ссылки, а собственной организации
    | с его ИНН в базе нет, — поэтому список ведём и на своей стороне.
    |
    ...
    */
    'excluded_contractor_tax_ids' => [
        ...
        '180740002214', // Андрей-К ТОО (Казахстан) — бывшее собственное юрлицо, круг 12
    ],
];
