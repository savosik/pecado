        ...
        'index-settings' => [
            Product::class => [
                ...
                'typoTolerance' => [
                    ...
                    // Опечатки на чисто числовых токенах отключены: коды вида
                    // "00008062" и "00008082" различаются на 1 цифру, и без этого
                    // typo tolerance матчил их через индексированное поле name.
