...
/**
 * Права на финансовый раздел CRM (план поступлений, просрочка, балансы).
 *
 * Сидер ролей на деплое не перезапускается, поэтому новые права раздаёт миграция —
 * иначе на dev и проде раздел «Финансы» был бы невидим всему отделу продаж.
 *
 * Границы внутри права задаёт скоуп клиентов: менеджер видит деньги только своих,
 * весь отдел — тот, у кого есть crm-clients-all.view.
 *
