...
- товар награды не входит в селектор условия того же правила — иначе промо-позиция
  начнёт влиять на собственное условие (движок её и так исключает, но на уровне
  конфигурации это ошибка настройки, о которой лучше сказать сразу).
