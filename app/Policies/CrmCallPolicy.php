 ...
 * за отпускника, должен видеть, о чём с клиентом уже говорили.
 *
 * Право `crm-calls.*` даёт возможность работать со звонками, но не отменяет скоуп
 * клиентов: без проверки видимости менеджер, зная ID, читал бы историю разговоров
 * по чужому клиенту в обход `User::visibleInCrm()`.
 *
