...
interface PromoStockCheckerInterface
{
    ...
    /**
     * Забыть снимок доступности предыдущего вычисления.
     *
     * Реализация вправе кэшировать ответы в пределах одного расчёта, чтобы все
     * награды судились по одному состоянию склада. Движок вызывает этот метод
     * перед каждым `evaluate()`: в долгоживущем процессе (тесты, очередь,
     * Octane) иначе залипнут числа, посчитанные до изменения заказов.
     */
