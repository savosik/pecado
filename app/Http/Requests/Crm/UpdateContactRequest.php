...
/**
 * Проверка правки карточки человека.
 *
 * Отличается от создания одним: привязка здесь не заводится — для неё есть
 * отдельные маршруты, и смешивать «поправить телефон» с «сменить роль»
 * значило бы прятать второе внутри первого.
 */
