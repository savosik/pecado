...
class HomeController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('User/Home', [
            ...
            'seo' => [
                'title' => 'Секс-шоп Pecado — интернет-магазин товаров для взрослых',
                'description' => 'Секс-шоп Pecado: вибраторы, фаллоимитаторы, смазки, бельё, БАДы. Анонимная доставка по России, конфиденциальная упаковка. В наличии, выгодные цены.',
