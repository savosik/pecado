...
class RoleController extends Controller
{
    ...
    protected array $permissionGroups = [
        ...
        'CRM' => ['crm-dashboard', 'crm-clients', 'crm-clients-all', 'crm-team', 'crm-analytics', 'crm-profile', 'crm-comments', 'crm-attachments', 'crm-tasks', 'crm-emails'],
    ...
    protected array $resourceLabels = [
        ...
        'crm-tasks' => 'CRM: Задачи', 'crm-emails' => 'CRM: Письма',
