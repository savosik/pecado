...
class RoleController extends Controller
{
    ...
    protected array $permissionGroups = [
        ...
        'CRM' => ['crm-dashboard', 'crm-clients', 'crm-clients-all', 'crm-contractors', 'crm-team', 'crm-analytics', 'crm-profile', 'crm-comments', 'crm-attachments', 'crm-tasks', 'crm-calls', 'crm-emails', 'crm-plans', 'crm-opportunities', 'crm-beds', 'crm-finance', 'crm-agent-tokens', 'crm-impersonate'],
    ...
    protected array $resourceLabels = [
        ...
        'crm-clients-all' => 'CRM: Партнёры всего отдела', 'crm-contractors' => 'CRM: Контрагенты',
