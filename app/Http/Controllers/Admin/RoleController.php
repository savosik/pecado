...
class RoleController extends Controller
{
    ...
    protected array $resourceLabels = [
        ...
        'crm-tasks' => 'CRM: Задачи', 'crm-calls' => 'CRM: Звонки', 'crm-emails' => 'CRM: Письма', 'crm-plans' => 'CRM: Планы продаж', 'crm-finance' => 'CRM: Финансы', 'crm-shortages' => 'CRM: Недоборы', 'crm-shortage-reasons' => 'CRM: Причины недоборов', 'crm-reserves' => 'CRM: Резервы заказов', 'crm-contacts' => 'CRM: Контакты', 'crm-contracts' => 'CRM: Договоры', 'crm-agent-tokens' => 'CRM: Токены ИИ-агентов', 'crm-impersonate' => 'CRM: Вход под партнёром', 'crm-salary' => 'CRM: Зарплата', 'crm-motivation' => 'CRM: Мотивация 2.0',
