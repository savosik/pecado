...
class RoleController extends Controller
{
    ...
    protected array $permissionGroups = [
        ...
        'Склад (WMS)' => ['wms-dashboard', 'wms-defects', 'wms-defect-types'],
    ...
    protected array $resourceLabels = [
        ...
        'crm-tasks' => 'CRM: Задачи', 'crm-calls' => 'CRM: Звонки', 'crm-emails' => 'CRM: Письма', 'crm-plans' => 'CRM: Планы продаж', 'crm-opportunities' => 'CRM: Возможности', 'crm-beds' => 'CRM: Грядки', 'crm-agent-tokens' => 'CRM: Токены ИИ-агентов',
