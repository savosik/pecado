...
class RoleController extends Controller
{
    ...
    protected array $permissionGroups = [
        ...
        'CRM' => ['crm-dashboard', 'crm-clients', 'crm-clients-all', 'crm-team', 'crm-analytics', 'crm-comments', 'crm-attachments'],
    ...
    protected array $resourceLabels = [
        ...
        'crm-analytics' => 'CRM: Отчёты продаж', 'crm-comments' => 'CRM: Комментарии', 'crm-attachments' => 'CRM: Вложения',
