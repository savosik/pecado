...
class RoleController extends Controller
{
    ...
    protected array $permissionGroups = [
        ...
        'CRM' => ['crm-dashboard', 'crm-clients', 'crm-clients-all', 'crm-department', 'crm-leads', 'crm-lead-stages', 'crm-contractors', 'crm-team', 'crm-absences', 'crm-timesheet', 'crm-analytics', 'crm-profile', 'crm-comments', 'crm-attachments', 'crm-tasks', 'crm-calls', 'crm-emails', 'crm-plans', 'crm-finance', 'crm-shortages', 'crm-questions', 'crm-shortage-reasons', 'crm-reserves', 'crm-contacts', 'crm-contracts', 'crm-agent-tokens', 'crm-agent-usage', 'crm-impersonate', 'crm-salary', 'crm-motivation'],
        'Склад (WMS)' => ['wms-dashboard', 'wms-defects', 'wms-defect-types', 'wms-goods-issues', 'wms-deliveries', 'wms-delivery-settings', 'wms-stock-buffers', 'wms-pickups', 'wms-access'],
    ...
    protected array $resourceLabels = [
        ...
        'crm-dashboard' => 'CRM: Рабочий стол', 'crm-clients' => 'CRM: Мои партнёры',
        'crm-clients-all' => 'CRM: Разрезы по менеджерам (РОП)',
        'crm-department' => 'CRM: Записи всего отдела',
        'crm-leads' => 'CRM: Лиды', 'crm-lead-stages' => 'CRM: Стадии воронки лидов',
        'crm-contractors' => 'CRM: Контрагенты',
        'crm-team' => 'CRM: Команда',
        'crm-absences' => 'CRM: Отсутствия и замещения', 'crm-timesheet' => 'CRM: Табель отдела',
        'crm-analytics' => 'CRM: Отчёты продаж', 'crm-profile' => 'CRM: Профиль партнёра', 'crm-comments' => 'CRM: Комментарии', 'crm-attachments' => 'CRM: Вложения',
        'crm-tasks' => 'CRM: Задачи', 'crm-calls' => 'CRM: Звонки', 'crm-emails' => 'CRM: Письма', 'crm-plans' => 'CRM: Планы продаж', 'crm-finance' => 'CRM: Финансы', 'crm-shortages' => 'CRM: Недоборы', 'crm-questions' => 'CRM: Вопросы клиентов', 'crm-shortage-reasons' => 'CRM: Причины недоборов', 'crm-reserves' => 'CRM: Резервы заказов', 'crm-contacts' => 'CRM: Контакты', 'crm-contracts' => 'CRM: Договоры', 'crm-agent-tokens' => 'CRM: Токены ИИ-агентов', 'crm-agent-usage' => 'CRM: ИИ-агенты клиентов', 'crm-impersonate' => 'CRM: Вход под партнёром', 'crm-salary' => 'CRM: Зарплата', 'crm-motivation' => 'CRM: Мотивация 2.0',
        ...
        'contractor-balances' => 'Балансы', 'payments' => 'Платежи (из 1С)',
