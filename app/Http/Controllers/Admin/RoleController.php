...
class RoleController extends Controller
{
    ...
    protected array $permissionGroups = [
        ...
        'CRM' => ['crm-dashboard', 'crm-clients', 'crm-clients-all', 'crm-department', 'crm-leads', 'crm-lead-stages', 'crm-contractors', 'crm-team', 'crm-analytics', 'crm-profile', 'crm-comments', 'crm-attachments', 'crm-tasks', 'crm-calls', 'crm-emails', 'crm-plans', 'crm-opportunities', 'crm-beds', 'crm-finance', 'crm-agent-tokens', 'crm-impersonate'],
    ...
    protected array $resourceLabels = [
        ...
        'crm-tasks' => 'CRM: Задачи', 'crm-calls' => 'CRM: Звонки', 'crm-emails' => 'CRM: Письма', 'crm-plans' => 'CRM: Планы продаж', 'crm-opportunities' => 'CRM: Возможности', 'crm-beds' => 'CRM: Грядки', 'crm-finance' => 'CRM: Финансы', 'crm-agent-tokens' => 'CRM: Токены ИИ-агентов', 'crm-impersonate' => 'CRM: Вход под партнёром',
