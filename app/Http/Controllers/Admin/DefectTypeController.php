...
/**
 * Справочник типовых дефектов — управление закупщиком/админом.
 *
 * Значения из справочника показываются кладовщику чипами при заведении
 * некондиции (Wms\DefectController). Здесь их заводят, правят и скрывают.
 */
class DefectTypeController extends Controller
{
    public function index(): Response
    {
        return Inertia::render('Admin/Pages/DefectTypes/Index', [
