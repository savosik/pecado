...
/**
 * Набор фильтров рабочего списка клиентов.
 *
...
final class ClientListFilters
{
     ...
     * менеджер подставил бы чужой manager_id в адрес и увидел чужих клиентов.
     ...
     * факт нужен по всем видимым клиентам. Ветка тяжёлая, поэтому включается
