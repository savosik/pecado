...
/**
 * Поиск партнёра по имени, записанному в управленческой таблице.
 *
 * Таблица и 1С называют одного и того же партнёра по-разному: «Ракович Владимир
 * Сергеевич ИП, г.Москва» против «Ракович Владимир Сергеевич», «Гевея, г. Москва»
 * против «ООО Гевея». Сравнение строк как есть находит пять партнёров из двухсот —
 ...
 * миллионы, и вскроется это к концу месяца, тогда как ненайденный партнёр честно
...
final class ClientNameIndex
{
    ...
    /**
     * Партнёр под всеми известными именами: рабочим наименованием из 1С и именем на сайте.
     */
