...
/**
 * Одна строка клиента из управленческой таблицы продаж.
 *
...
{
    /** Строка описывает конкретного клиента, которого нужно найти в базе. */
    public const KIND_CLIENT = 'client';

    /**
     * Строка-«корзина» вида «Новые клиенты Иван»: план на тех, кого ещё не
     * привлекли. Клиента за ней нет, поэтому она уходит в план менеджера.
     */
