...
class QuestionReceivedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('Ваш вопрос принят — Pecado.ru')
            ->markdown('mail.user-questions.received', [
