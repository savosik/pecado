 ...
 * contacts.unsubscribe_token и живые OAuth-токены в social_accounts.
...
class BiSyncGrants extends Command
{
    ...
    /**
     * Коммерческая тайна на уровне таблиц: зарплата менеджеров (эпики sal-00 и mot-00).
     * BI-агентом пользуются сами менеджеры, а чужой доход — не их дело. Префикс,
     * а не список: будущие payroll_* и motivation_* не должны утечь по забывчивости.
     */
    private const CONFIDENTIAL_TABLE_PREFIXES = [
        ...
        // Переписка клиентов с чатом-помощником и заметки о них (assist-00):
        // конфиденциально, менеджерам доступно только через CRM по правам.
        'chat_',
        'client_assistant_',
    ];
