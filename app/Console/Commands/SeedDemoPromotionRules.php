 ...
 * подарок, пробник со склада «Москва реклама», подарок на выбор, отклоняемая
...
class SeedDemoPromotionRules extends Command
{
    ...
    protected $signature = 'promo:seed-demo
                            ...
                            {--sample-stock=50 : Остаток пробника на складе «Москва реклама», если его там нет (0 — не проставлять)}
    ...
    {
        return [
            'name' => self::PREFIX.' Пробник со склада «Москва реклама»: 2 шт. → образец',
