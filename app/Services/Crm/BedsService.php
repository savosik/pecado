 ...
 * в «Планах продаж» для того же партнёра, а два движка расчёта совпадать перестают
...
class BedsService
{
    ...
    /**
     * Полотно партнёров: плитка на партнёра внутри плана скоупа.
     *
    ...
    /**
     * Плитка партнёра или null, если рисовать нечего.
     *
    ...
    private function clientTile(array $row): ?array
    {
        ...
        // этого отсева полотно превращается в песок из нулевых партнёров.
        if ($area <= 0) {
            return null;
        }
        ...
        return [
            ...
            // по которому партнёр попадает в пресет «спящие» на «Возможностях».
