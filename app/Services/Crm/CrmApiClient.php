...
/**
 * Партнёр агентского CRM-API — тот же, которым ходит ИИ-агент менеджера.
 *
 ...
 * ответственность за записи — его: в ленте партнёра правка будет выглядеть как
...
class CrmApiClient
{
     ...
     * середине импорта — значит оставить половину партнёров без планов. Дешевле
