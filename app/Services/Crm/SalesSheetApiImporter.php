 ...
 * набор сопоставленных партнёров, где бы импорт ни выполнялся.
 *
...
class SalesSheetApiImporter
{
    ...
    /** Партнёров на страницу: верхняя граница, которую принимает `client.list`. */
    ...
    /**
     * Партнёры боевой CRM: индекс по имени, менеджер каждого партнёра и список менеджеров.
     *
    ...
    private function fetchClients(): array
    {
        ...
        do {
            ...
            foreach ($rows as $row) {
                ...
                // Список отдаёт подпись партнёра (рабочее наименование из 1С,
    ...
    /**
     * Паспорт и статус партнёра через API.
     *
