...
/**
 * Единственная точка изменения профиля клиента.
 *
...
{
    /**
     * Профиль клиента — существующий или пустой заготовкой.
     *
     * Незаписанный экземпляр вместо null: карточка клиента должна открываться
     * и у клиента, которого ещё никто не описывал.
     */
    ...
    /**
     * Интересы клиента как простой список названий.
     *
     * @return list<string>
     */
