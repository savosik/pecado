...
/**
 * Аналитика одного партнёра: тренд, разрезы и последние документы.
 *
 * Один и тот же ответ нужен двум потребителям — провалу в партнёра на «грядках»
 * и операции `client.sales` агентского API. Своей арифметики здесь нет: всё
 * считает {@see ShipmentAnalyticsService} с контекстом из одного партнёра,
