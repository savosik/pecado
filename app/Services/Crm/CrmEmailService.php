 ...
 * и провалившаяся. Письмо, о судьбе которого менеджер узнаёт только от клиента,
...
class CrmEmailService
{
     ...
     *
     * Переписка с клиентом — история клиента, а не личное дело автора: менеджер видит
     * письма по своим клиентам независимо от того, кто их писал. Письма без клиента
    ...
    /**
     * Форма письма для фронта — одна на журнал, карточку и ленту клиента.
     *
