...
class ClientAvatarGenerator
{
    ...
    - Это ПОРТРЕТ и только портрет: голова и плечи одного персонажа, лицом к нам,
      лицо занимает не меньше половины кадра. Начинай промт со слов
      «Close-up head-and-shoulders portrait of».
    - НИКАКИХ фигур в полный рост, поясных планов, сцен и интерьеров: аватарка
      живёт размером 28 пикселей в списке, и всё, кроме лица, там превращается
      в цветное пятно.
    - Реквизит только тот, что помещается у лица: очки, наушники, шляпа, галстук-бабочка,
      кружка. Никаких столов, полок, тележек, коробок и витрин.
    ...
    - Масштаб дела передавай выражением лица и осанкой, а не размахом сцены:
      у крупного партнёра уверенный вид, у маленького — простодушный и тёплый.
      Фон всегда одноцветный, сцены нет.
    - Стиль: friendly flat vector mascot portrait, bold clean shapes, soft studio
      light, plain solid background, face centered and filling the square.
    TXT;
