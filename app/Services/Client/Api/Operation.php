...
final class Operation
{
     ...
     * строковые идентификаторы — всё кроме слэша. Статические адреса вроде
     * `orders/changes` регистрируются раньше параметрических (порядок в секции).
     *
    ...
    public function routeConstraints(): array
    {
        ...
        foreach ($this->pathParams() as $name) {
            ...
            // Строковые идентификаторы — любые символы кроме слэша: номера
            // документов 1С содержат кириллицу («29УТ-003413»).
