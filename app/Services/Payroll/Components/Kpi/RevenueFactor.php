...
class RevenueFactor extends AbstractComponent
{
    ...
    {
        return 'Отгрузки ваших партнёров за месяц. План по отгрузкам, а не по деньгам: неоплаченная накладная считается полностью.';
    }

    public function howComputed(): string
    {
        return 'Реализации ÷ план. Та же цифра, что на «Планах продаж».';
    }
