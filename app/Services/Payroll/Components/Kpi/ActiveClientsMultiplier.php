...
class ActiveClientsMultiplier extends AbstractComponent
{
    ...
    {
        return 'Доля плановых партнёров, которые сделали закупку в этом месяце. Плановые — те, на кого назначен план продаж на месяц. Партнёр с несколькими юрлицами считается одним.';
    }

    public function howComputed(): string
    {
        return 'Купивших из плановых ÷ плановых → доля; по лестнице доле соответствует множитель, на который умножается выполнение плана по выручке.';
    }
