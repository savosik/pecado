...
РЕЗЮМЕ:
<2–4 предложения: что клиент хотел, что сделано, что осталось открытым>

ЗАМЕТКА:
<обновлённая заметка о клиенте: как обращаться, что и как часто заказывает, предпочтения по доставке и оплате, договорённости, что уже обсуждали. Сохрани из текущей заметки всё ещё актуальное, добавь новое, убери устаревшее. До 2000 знаков, без токенов, паролей и телефонов. Если добавить нечего — повтори текущую заметку.>
