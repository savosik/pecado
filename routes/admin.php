...
Route::middleware(['web', 'auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('permission:individual-prices.view')->group(function () {
        ...
        Route::get('/individual-prices/show', [\App\Http\Controllers\Admin\IndividualPriceController::class, 'show'])->name('individual-prices.show');
    });
    ...
    Route::middleware('permission:settings.view')->group(function () {
        ...
        Route::delete('/kanban/{kanbanTask}', [\App\Http\Controllers\Admin\KanbanController::class, 'destroy'])->name('kanban.destroy');
    });
