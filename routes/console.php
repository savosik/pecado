...
// Рубильник MAIL_WEEKLY_RECONCILIATION_SCHEDULED (config/mail_stream.php) останавливает
// именно акты, не трогая остальной поток; появился при оживлении планировщика 09.09.2026.
