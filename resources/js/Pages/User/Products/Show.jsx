...
export default function Show() {
    const { product, media, categoryTrail, variants, certificates, specifications, specificationGroups, sizeChart, similarProducts, promotions, defects, currency, auth, seo } = usePage().props;
