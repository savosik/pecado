...
export default function ShipmentShow({ shipment, related_orders, overdue_detail }) {
    ...
    return (
        <CabinetLayout title={`Отгрузка #${shipment.id}`}>
            ...
            {/* Основная информация */}
            <Card.Root bg="white" _dark={{ bg: "gray.800", borderColor: 'gray.700' }} mb={6} borderRadius="xl" border="1px solid" borderColor="gray.100">
                <Card.Header>
            ...
            {overdue_detail && (
                <Card.Root bg="white" _dark={{ bg: "gray.800", borderColor: 'red.800' }} mb={6} borderRadius="xl" border="2px solid" borderColor="red.200">
                    <Card.Body p={4}>
