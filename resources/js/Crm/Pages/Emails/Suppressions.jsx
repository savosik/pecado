...
export default function Suppressions({ suppressions, canManage }) {
    ...
    return (
        <>
            ...
            <PageHeader
                title="Заблокированные адреса"
                description="Технический запрет: почта отбивает доставку или адрес пожаловался на спам"
            />

            <MailNav description="Адреса, куда мы не пишем по техническим причинам: почтовый сервер отбил доставку или адресат пожаловался на спам. Обычный отказ клиента от писем живёт не здесь, а в матрице уведомлений — в карточке партнёра и у него в кабинете." />
