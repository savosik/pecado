 ...
 * проваливает в его грядки клиентов, клик по клиенту открывает панель аналитики.
 * Менеджер сразу видит своих клиентов — уровня отдела у него нет.
 */
                    ...
                    <>
                        ...
                        <Text fontSize="sm" color="fg.muted">
                            {data.mode === 'managers'
                                ...
                                : `Плитка — клиент${managerName ? `, менеджер ${managerName}` : ''}. Нажмите, чтобы открыть аналитику.`}
                        ...
                        {(data.tiles ?? []).length === 0 ? (
                            <Alert status="info" title="Полотно пустое">
                                {data.mode === 'managers'
                                    ...
                                    : 'Ни у одного клиента нет ни плана на месяц, ни отгрузок за год. Грядку рисовать не из чего — задайте планы на «Планах продаж».'}
                            </Alert>
                        ) : (
