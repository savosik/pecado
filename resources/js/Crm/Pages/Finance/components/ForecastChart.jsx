...
export default function ForecastChart({ curve, target, horizon }) {
    ...
    return (
        <Box height="260px">
            ...
            <HStack gap={4} justify="center" mt={1} fontSize="10px" color="fg.muted" wrap="wrap">
                ...
                <Legend color="var(--chakra-colors-blue-muted)" text="коридор: консервативно — оптимистично" />
            </HStack>
        </Box>
    );
}
