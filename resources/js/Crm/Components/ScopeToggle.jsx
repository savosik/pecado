 ...
 * С ней в списке остаются только партнёры без менеджера. В отличие от разреза
 * она серверная и действует сразу во всех разделах.
 *
            ...
            {! isMine && (
                <Tooltip
                    content={unassigned.enabled
                        ? 'Показаны только партнёры без персонального менеджера, во всех разделах CRM. Снимите, чтобы вернуться ко всему отделу.'
                        : 'Оставить только партнёров без персонального менеджера (лидов), во всех разделах CRM.'}
                    openDelay={400}
                >
