...
/**
 * Звонок партнёру: набрать и записать, чем закончилось.
 *
 ...
 * когда о партнёре думают в последний раз, и если сейчас не назначить следующий шаг,
 * партнёр выпадет из работы до своего входящего.
 *
 * @param {boolean} open
                            ...
                            <VStack align="stretch" gap={4}>
                                {client.phone ? (
                                    ...
                                    <Text fontSize="sm" color="fg.muted">
                                        У партнёра не указан телефон — запишите звонок вручную.
                                    </Text>
                                )}
