...
const FavoriteEdit = ({ favorite }) => {
    ...
    const handleSubmit = (e) => {
        ...
        put(route("admin.favorites.update", favorite.id), {
            onSuccess: () => {
                toaster.create({
                    description: "Запись избранного обновлена",
                    type: "success",
                });
            },
            onError: (errors) => {
    ...
    return (
        ...
        >
            ...
            <PageHeader
                title={`Редактирование избранного #${favorite.id}`}
                actions={
                    <HStack>
                        <Button
                            variant="ghost"
                            onClick={() => router.visit(route("admin.favorites.index"))}
                        >
                            <LuArrowLeft /> Отмена
                        </Button>
                        <Button
