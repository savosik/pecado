...
export default function Create({ currencies }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.user-balances.store'), {
            onSuccess: () => {
                toaster.create({
                    title: 'Баланс успешно создан',
                    type: 'success',
                });
            },
            onError: () => {
                toaster.create({
                    title: 'Ошибка при создании баланса',
    ...
    return (
        <>
            <PageHeader title="Создать баланс" />
