...
const ReturnsCreate = () => {
    const { users, statuses, reasons } = usePage().props;
    ...
    const handleSubmit = (e) => {
        ...
        setSubmitting(true);
        router.post(route("admin.returns.store"), formData, {
            onSuccess: () => {
                toaster.create({
            ...
            onError: (errors) => {
                setErrors(errors);
                toaster.create({
                    description: "Ошибка при создании возврата",
                    type: "error",
                });
                setSubmitting(false);
            },
