        ...
        >
            ...
            >
                ...
                >
                    ...
                    использованием файлов Cookie и сервисов Яндекс Метрика.
                    Продолжая пользоваться Сайтом, Вы даёте{' '}
                    <Link
                        href="/pages/personal-data-consent"
                    ...
                    , в противном случае Вам необходимо прекратить использование
                    Сайта или запретить работу с cookies в настройках своего
                    браузера.
                </Text>
                <Button
                    colorPalette="pecado"
