...
<head>
    ...
    {{-- Stoplight Elements отдаётся с нашего домена: CSP прода (docker/nginx/prod.conf)
         не пускает скрипты с unpkg.com, и страница документации оставалась белой. --}}
    <script src="{{ asset('vendor/stoplight-elements/8.4.2/web-components.min.js') }}"></script>
    <link rel="stylesheet" href="{{ asset('vendor/stoplight-elements/8.4.2/styles.min.css') }}">
