...
<body>
    <div class="card">
        ...
        <p>Подписки на изменения заказов из кабинета заменены настройками уведомлений:
            там для каждого типа письма можно выбрать, кому и приходит ли оно вообще.</p>
        <p class="muted"><a href="{{ url('/cabinet/notifications') }}">Открыть настройки уведомлений</a></p>
            </p>
